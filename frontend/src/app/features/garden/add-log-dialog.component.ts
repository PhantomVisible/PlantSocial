...
@Component({
  ...
  `,
    ...
    .dialog__header h2 { margin: 0; font-size: 1.1rem; font-weight: 700; color: #333; }
    .dialog__close { background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #999; }
    ...
    .upload-placeholder { display: flex; flex-direction: column; align-items: center; gap: 4px; color: #999; }
    ...
    .field input:focus, .field textarea:focus { border-color: #2E7D32; outline: none; }

    .dialog__footer { padding: 16px 20px; display: flex; justify-content: flex-end; gap: 10px; background: #fafafa; }
